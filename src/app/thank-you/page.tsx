...
import { CheckCircle, ArrowRight, Sparkles, Users } from "lucide-react"
          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="text-sm xs:text-base sm:text-lg md:text-xl text-blue-100 mb-4 sm:mb-8 leading-relaxed px-2">
                Endi siz <span className="text-yellow-400 font-bold">10 kunlik AI Personal Branding</span>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-6 mb-4 sm:mb-8 border border-white/20 mx-2 sm:mx-4">
                <h3 className="text-white font-bold text-sm sm:text-lg mb-1 sm:mb-2">Keyingi qadam:</h3>
                <p className="text-blue-100 text-xs sm:text-sm leading-relaxed">
                  Telegram kanalimizga qo'shilib, birinchi vazifangizni oling va boshqa ishtirokchilar bilan tanishing!
                </p>
              </div>
            </div>
            ...
            >
              <Button
                ...
                size="lg"
                className="w-full sm:w-auto bg-gradient-to-r from-yellow-500 to-orange-500 hover:from-yellow-600 hover:to-orange-600 text-white font-bold py-3 px-6 sm:py-6 sm:px-12 text-sm sm:text-xl rounded-xl sm:rounded-2xl shadow-2xl transform hover:scale-105 transition-all duration-300 border-2 border-yellow-400 animate-pulse"
              >
                <Users className="h-4 w-4 sm:h-6 sm:w-6 mr-2 sm:mr-3" />
                <span className="text-xs sm:text-base md:text-xl">TELEGRAM KANALGA QO'SHILISH</span>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4 max-w-xs sm:max-w-md mx-auto px-2">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl p-2 sm:p-4 text-center border border-white/20">
                <div className="text-lg sm:text-2xl font-bold text-blue-400">10</div>
                <div className="text-xs sm:text-xs text-blue-100">Kun Challenge</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl p-2 sm:p-4 text-center border border-white/20">
                <div className="text-lg sm:text-2xl font-bold text-blue-400">100%</div>
                <div className="text-xs sm:text-xs text-blue-100">Bepul</div>
              </div>
              <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl p-2 sm:p-4 text-center border border-white/20">
                <div className="text-lg sm:text-2xl font-bold text-blue-400">AI</div>
                <div className="text-xs sm:text-xs text-blue-100">Powered</div>
              </div>
            </div>
          </div>
        </div>
